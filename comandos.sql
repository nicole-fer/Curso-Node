...
/* Comando para ver uma tabelas -> DESCRIBE usuarios; */
/* Para listar dados de uma tabela -> SELECT * FROM usuarios; */
/* Para fazer consultas . Ex.: SELECT * FROM usuarios WHERE idade = 23 */
